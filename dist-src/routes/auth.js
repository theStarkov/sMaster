            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                        ...
                        _context2.next = 8;
                        return _bcrypt2.default.compare(req.body.password, q.password);
                    ...
                    case 9:
                        ...
                        token = (0, _jwToken.genToken)({ user: q });
                        return _context2.abrupt("return", res.status(200).json({ resp_code: '200', resp_desc: "Login successful", token: token }));

                    case 14:
                        return _context2.abrupt("return", res.status(404).json({ resp_code: '403', resp_desc: "Incorrect Email or Password" }));
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 3:
                        ...
                        res.status(404).json({ resp_code: '403', resp_desc: "Account already exists" });_context3.next = 16;
                        break;
                    ...
                    case 10:
                        ...
                        res.status(200).json({ resp_code: '200', resp_desc: "Account created successful", token: token });
...
router.put('/update-sound-level', function () {
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _context4.prev = 2;
                        _context4.next = 5;
                        return _User2.default.findOne({ where: { deviceId: id } });
